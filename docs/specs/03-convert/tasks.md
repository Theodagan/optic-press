...
1. [ ] Define convert settings model and defaults. → needs: —
2. [ ] Implement output format and MIME mapping. → needs: —
3. [ ] Build Convert workspace controls. → needs: 1, 2
4. [ ] Wire batch conversion through shared processor. → needs: 3
5. [ ] Wire bulk ZIP download. → needs: 4
