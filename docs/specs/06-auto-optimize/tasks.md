...
2. [x] Implement auto format selection rules. → needs: 1
...
6. [x] Implement original fallback and already-optimal badge state. → needs: 4
7. [x] Build Auto Optimize workspace controls and result rendering. → needs: 2, 3, 4, 5, 6
8. [x] Add tests for detection, format selection, binary search, and fallback. → needs: 1, 2, 4, 6
